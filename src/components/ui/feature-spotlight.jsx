...
export function FeaturedSpotlight({
    ...
    imageUrl = "https://plus.unsplash.com/premium_photo-1681338224373-9669c2497c05?q=80&w=2307&auto=format&fit=crop",
    index = "01",
    label = "Featured",
    onLearnMore
}) {
    ...
    return (
        <div
            className="group relative flex cursor-pointer flex-col items-center gap-8 md:flex-row md:items-start md:gap-12 lg:gap-16 py-12"
